...
WiFi-Kanal 6 wird per `esp_wifi_set_channel()` gesetzt fuer Koexistenz mit der Bridge (WiFi) und dem Router.
...
- WiFi-Kanal 6 per esp_wifi_set_channel() fuer Bridge-Koexistenz
