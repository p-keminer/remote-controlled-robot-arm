...
// Bei 50 Hz Loop und MAX_SCHRITT=3: max 150 Grad/Sekunde.
// Glaettet Bewegung, bleibt fuer den ersten echten Greifer-Test aber reaktionsfreudig.
#define MAX_SCHRITT  3
