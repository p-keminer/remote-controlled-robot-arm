...
Alle ESPs laufen auf WiFi-Kanal 6 (Router-Kanal) fuer ESP-NOW/WiFi-Koexistenz.
...
- ESP-NOW und WiFi muessen auf dem gleichen Funkkanal laufen (aktuell Kanal 6)
...
- WiFi-Kanal 6 muss zum Router-Kanal und zum Controller/Receiver passen
