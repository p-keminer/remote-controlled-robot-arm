...
- ein zweiter ESP32 empfaengt Funkdaten, validiert sie und leitet sie ueber UART weiter
...
3. Das Ergebnis wird in ein `ESP-NOW`-Frame mit Integritaets-, Session- und Frischeannahmen ueberfuehrt.
