...
Die erste Version wird als lokal betriebenes Embedded-System vorbereitet: `ESP-NOW` zwischen den ESP32, `I2C` zum Arduino, kein WLAN und keine Cloud-Anbindung in v1.
...
- Security-Uplift nach erster I2C-Grundkette

Abgeschlossen (Stand 2026-04-02):
