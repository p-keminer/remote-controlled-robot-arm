...
Die I2C-Kette Receiver → Arduino ist bench-validiert (2026-04-02). Naechste Schritte sind IMU-zu-Servo-Mapping sowie eine spaetere Protokollerweiterung mit klaren Erweiterungspunkten fuer den Security-Uplift.
