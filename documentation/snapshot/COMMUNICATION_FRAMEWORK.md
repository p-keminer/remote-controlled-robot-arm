...
- Timeout und Neutralverhalten muessen auf beiden Seiten abgestimmt sein (Arduino: 1s Timeout → Neutralposition).
- Batteriebetrieb ist fuer dauerhaften Servobetrieb erforderlich (USB 500mA reicht nicht fuer 5 Servos bei permanentem PWM).
...
- die I2C-Grundkette Receiver → Arduino ist bench-validiert (bestaetigt 2026-04-02); der Security-Uplift ist der naechste Schritt
...
## Frame v1 - Minimaler Startstand fuer Receiver -> Arduino (transportiert ueber I2C)
